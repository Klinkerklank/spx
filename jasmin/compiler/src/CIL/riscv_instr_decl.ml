...
let riscv_add_semi wn wm =
  Obj.magic add_word riscv_decl.reg_size wn wm
...
let riscv_sub_semi wn wm =
  Obj.magic sub_word riscv_decl.reg_size wn wm
...
let riscv_slt_semi wn wm =
  if wlt riscv_decl.reg_size Signed (Obj.magic wn) (Obj.magic wm)
  then Obj.magic word1 riscv_decl.reg_size
  else Obj.magic word0 riscv_decl.reg_size
...
let riscv_sltu_semi wn wm =
  if wlt riscv_decl.reg_size Unsigned (Obj.magic wn) (Obj.magic wm)
  then Obj.magic word1 riscv_decl.reg_size
  else Obj.magic word0 riscv_decl.reg_size
...
let riscv_and_semi wn wm =
  Obj.magic wand riscv_decl.reg_size wn wm
...
let riscv_or_semi wn wm =
  Obj.magic wor riscv_decl.reg_size wn wm
...
let riscv_xor_semi wn wm =
  Obj.magic wxor riscv_decl.reg_size wn wm
...
(** val riscv_sll_semi : sem_tuple -> word -> sem_tuple **)

let riscv_sll_semi wn wm =
  Obj.magic wshl riscv_decl.reg_size wn
    (wunsigned U8
      (wand U8 wm
...
(** val riscv_srl_semi : sem_tuple -> word -> sem_tuple **)

let riscv_srl_semi wn wm =
  Obj.magic wshr riscv_decl.reg_size wn
    (wunsigned U8
      (wand U8 wm
        (wrepr U8 (Zpos (Coq_xI (Coq_xI (Coq_xI (Coq_xI Coq_xH))))))))
...
(** val riscv_sra_semi : sem_tuple -> word -> sem_tuple **)

let riscv_sra_semi wn wm =
  Obj.magic wsar riscv_decl.reg_size wn
    (wunsigned U8
      (wand U8 wm
        (wrepr U8 (Zpos (Coq_xI (Coq_xI (Coq_xI (Coq_xI Coq_xH))))))))
...
let riscv_NOT_semi wn =
  Obj.magic wnot riscv_decl.reg_size wn
...
let riscv_NEG_semi wn =
  Obj.magic opp_word riscv_decl.reg_size wn
...
(** val riscv_extend_semi : signedness -> wsize -> wsize -> word -> word **)
...
let riscv_mul_semi wn wm =
  Obj.magic mul_word riscv_decl.reg_size wn wm
...
let riscv_mulh_semi wn wm =
  Obj.magic wmulhs riscv_decl.reg_size wn wm
...
let riscv_mulhu_semi wn wm =
  Obj.magic wmulhu riscv_decl.reg_size wn wm
...
let riscv_mulhsu_semi wn wm =
  Obj.magic wmulhsu riscv_decl.reg_size wn wm
...
let riscv_div_semi wn wm =
  if eq_op (word_word__canonical__eqtype_Equality riscv_decl.reg_size) wm
       (Obj.magic word0 riscv_decl.reg_size)
  then Obj.magic opp_word riscv_decl.reg_size (word1 riscv_decl.reg_size)
  else Obj.magic wdivi riscv_decl.reg_size wn wm
...
let riscv_divu_semi wn wm =
  if eq_op (word_word__canonical__eqtype_Equality riscv_decl.reg_size) wm
       (Obj.magic word0 riscv_decl.reg_size)
  then Obj.magic opp_word riscv_decl.reg_size (word1 riscv_decl.reg_size)
  else Obj.magic wdiv riscv_decl.reg_size wn wm
...
let riscv_rem_semi wn wm =
  Obj.magic wmodi riscv_decl.reg_size wn wm
...
let riscv_remu_semi wn wm =
  Obj.magic wmod riscv_decl.reg_size wn wm
