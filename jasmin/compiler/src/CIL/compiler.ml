...
let compiler_step_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 f22 f23 f24 f25 f26 f27 f28 f29 f30 = function
| Typing -> f
| ParamsExpansion -> f0
| RemoveAssertion -> f1
| InsertRenaming -> f2
...
| LowerSpill -> f6
| Inlining -> f7
| RemoveUnusedFunction -> f8
| Unrolling -> f9
| Splitting -> f10
| Renaming -> f11
| RemovePhiNodes -> f12
| DeadCode_Renaming -> f13
| RemoveArrInit -> f14
| MakeRefArguments -> f15
| RegArrayExpansion -> f16
| RemoveGlobal -> f17
| LoadConstantsInCond -> f18
| LowerInstruction -> f19
| PropagateInline -> f20
| SLHLowering -> f21
| LowerAddressing -> f22
| StackAllocation -> f23
| RemoveReturn -> f24
| RegAllocation -> f25
| DeadCode_RegAllocation -> f26
| Linearization -> f27
| StackZeroization -> f28
| Tunneling -> f29
| Assembly -> f30
...
let compiler_step_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 f22 f23 f24 f25 f26 f27 f28 f29 f30 = function
| Typing -> f
| ParamsExpansion -> f0
| RemoveAssertion -> f1
| InsertRenaming -> f2
...
let is_compiler_step_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 f22 f23 f24 f25 f26 f27 f28 f29 f30 _ = function
| Coq_is_Typing -> f
| Coq_is_ParamsExpansion -> f0
| Coq_is_RemoveAssertion -> f1
| Coq_is_InsertRenaming -> f2
| Coq_is_WintWord -> f3
| Coq_is_ArrayCopy -> f4
| Coq_is_AddArrInit -> f5
| Coq_is_LowerSpill -> f6
| Coq_is_Inlining -> f7
| Coq_is_RemoveUnusedFunction -> f8
| Coq_is_Unrolling -> f9
| Coq_is_Splitting -> f10
| Coq_is_Renaming -> f11
| Coq_is_RemovePhiNodes -> f12
| Coq_is_DeadCode_Renaming -> f13
| Coq_is_RemoveArrInit -> f14
| Coq_is_MakeRefArguments -> f15
| Coq_is_RegArrayExpansion -> f16
| Coq_is_RemoveGlobal -> f17
| Coq_is_LoadConstantsInCond -> f18
| Coq_is_LowerInstruction -> f19
| Coq_is_PropagateInline -> f20
| Coq_is_SLHLowering -> f21
| Coq_is_LowerAddressing -> f22
| Coq_is_StackAllocation -> f23
| Coq_is_RemoveReturn -> f24
| Coq_is_RegAllocation -> f25
| Coq_is_DeadCode_RegAllocation -> f26
| Coq_is_Linearization -> f27
| Coq_is_StackZeroization -> f28
| Coq_is_Tunneling -> f29
| Coq_is_Assembly -> f30
...
let is_compiler_step_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 f20 f21 f22 f23 f24 f25 f26 f27 f28 f29 f30 _ = function
| Coq_is_Typing -> f
| Coq_is_ParamsExpansion -> f0
| Coq_is_RemoveAssertion -> f1
| Coq_is_InsertRenaming -> f2
...
| RemoveAssertion -> Coq_xI Coq_xH
| InsertRenaming -> Coq_xO (Coq_xO Coq_xH)
| WintWord -> Coq_xI (Coq_xO Coq_xH)
| ArrayCopy -> Coq_xO (Coq_xI Coq_xH)
| AddArrInit -> Coq_xI (Coq_xI Coq_xH)
| LowerSpill -> Coq_xO (Coq_xO (Coq_xO Coq_xH))
| Inlining -> Coq_xI (Coq_xO (Coq_xO Coq_xH))
| RemoveUnusedFunction -> Coq_xO (Coq_xI (Coq_xO Coq_xH))
| Unrolling -> Coq_xI (Coq_xI (Coq_xO Coq_xH))
| Splitting -> Coq_xO (Coq_xO (Coq_xI Coq_xH))
| Renaming -> Coq_xI (Coq_xO (Coq_xI Coq_xH))
| RemovePhiNodes -> Coq_xO (Coq_xI (Coq_xI Coq_xH))
| DeadCode_Renaming -> Coq_xI (Coq_xI (Coq_xI Coq_xH))
| RemoveArrInit -> Coq_xO (Coq_xO (Coq_xO (Coq_xO Coq_xH)))
| MakeRefArguments -> Coq_xI (Coq_xO (Coq_xO (Coq_xO Coq_xH)))
| RegArrayExpansion -> Coq_xO (Coq_xI (Coq_xO (Coq_xO Coq_xH)))
| RemoveGlobal -> Coq_xI (Coq_xI (Coq_xO (Coq_xO Coq_xH)))
| LoadConstantsInCond -> Coq_xO (Coq_xO (Coq_xI (Coq_xO Coq_xH)))
| LowerInstruction -> Coq_xI (Coq_xO (Coq_xI (Coq_xO Coq_xH)))
| PropagateInline -> Coq_xO (Coq_xI (Coq_xI (Coq_xO Coq_xH)))
| SLHLowering -> Coq_xI (Coq_xI (Coq_xI (Coq_xO Coq_xH)))
| LowerAddressing -> Coq_xO (Coq_xO (Coq_xO (Coq_xI Coq_xH)))
| StackAllocation -> Coq_xI (Coq_xO (Coq_xO (Coq_xI Coq_xH)))
| RemoveReturn -> Coq_xO (Coq_xI (Coq_xO (Coq_xI Coq_xH)))
| RegAllocation -> Coq_xI (Coq_xI (Coq_xO (Coq_xI Coq_xH)))
| DeadCode_RegAllocation -> Coq_xO (Coq_xO (Coq_xI (Coq_xI Coq_xH)))
| Linearization -> Coq_xI (Coq_xO (Coq_xI (Coq_xI Coq_xH)))
| StackZeroization -> Coq_xO (Coq_xI (Coq_xI (Coq_xI Coq_xH)))
| Tunneling -> Coq_xI (Coq_xI (Coq_xI (Coq_xI Coq_xH)))
| Assembly -> Coq_xO (Coq_xO (Coq_xO (Coq_xO (Coq_xO Coq_xH))))
...
| RemoveAssertion -> Coq_is_RemoveAssertion
    ...
    (match x with
     ...
     | Coq_xO x0 ->
       (match x0 with
        ...
        | Coq_xO x1 ->
          (match x1 with
           | Coq_xI _ -> Some LowerAddressing
           | Coq_xO x2 ->
             (match x2 with
              | Coq_xI _ -> None
              | Coq_xO _ -> Some Assembly
...
type stack_alloc_oracles = { ao_globals : word list;
                             ao_global_alloc : ((Var.var * wsize) * coq_Z)
                                               list;
                             ao_stack_alloc : (funname -> stk_alloc_oracle_t) }

(** val ao_globals : stack_alloc_oracles -> word list **)
...
type ('asm_op, 'lowering_options) compiler_params = { extend_iinfo : 
                                                      (instr_info ->
                                                      instr_info ->
                                                      instr_info);
                                                      expand_fd : (funname ->
...
(** val extend_iinfo :
    'a1 asmOp -> ('a1, 'a2) compiler_params -> instr_info -> instr_info ->
    instr_info **)

let extend_iinfo _ c =
  c.extend_iinfo
...
let inlining asm_e cparams to_keep p =
  match inline_prog_err (asm_opI asm_e) cparams.extend_iinfo p with
  | Ok x ->
...
let compiler_first_part asm_e aparams cparams to_keep p =
  let p0 = remove_assert_prog (asm_opI asm_e) progUnit p in
  let p1 = cparams.print_uprog RemoveAssertion (Obj.magic p0) in
  (match wi2w_prog (asm_opI asm_e) withsubword
           (Obj.magic cparams.remove_wint_annot)
           (Obj.magic cparams.dead_vars_ufd) (Obj.magic p1) with
   | Ok x ->
     let p2 = cparams.print_uprog WintWord (Obj.magic x) in
     let p3 =
       insert_renaming_prog (asm_opI asm_e) progUnit cparams.insert_renaming
         (Obj.magic p2)
     in
     let p4 = cparams.print_uprog InsertRenaming (Obj.magic p3) in
     (match array_copy_prog (asm_opI asm_e) (fun k ii ->
              cparams.fresh_var_ident k ii (Uint63.of_int (0))) progUnit
              (Obj.magic p4) with
      | Ok x0 ->
        let p5 = cparams.print_uprog ArrayCopy (Obj.magic x0) in
        let p6 = add_init_prog (asm_opI asm_e) progUnit (Obj.magic p5) in
        let p7 = cparams.print_uprog AddArrInit (Obj.magic p6) in
        (match spill_prog (asm_opI asm_e) cparams.fresh_var_ident progUnit
                 (Obj.magic p7) with
         | Ok x1 ->
           let p8 = cparams.print_uprog LowerSpill (Obj.magic x1) in
           (match inlining asm_e cparams to_keep (Obj.magic p8) with
            | Ok x2 ->
                 ...
                 (match check_no_for_loop (asm_opI asm_e) x3 with
                  | Ok _ ->
                    (match check_no_inline_instr (asm_opI asm_e) x3 with
                     | Ok _ ->
                       let p9 = cparams.print_uprog Unrolling (Obj.magic x3)
                       in
                       (match dead_calls_err_seq (asm_opI asm_e) progUnit
                                to_keep (Obj.magic p9) with
                        | Ok x4 ->
                          let p10 =
                          ...
                          (match live_range_splitting asm_e aparams cparams
                           ...
                           | Ok x5 ->
                             ...
                             in
                             let pr0 =
                               cparams.print_uprog RemoveArrInit
                                 (Obj.magic pr)
                             in
                             (match makereference_prog (asm_opI asm_e)
                              ...
                              | Ok x6 ->
                                ...
                                (match expand_prog (asm_opI asm_e)
                                         (Obj.magic cparams.expand_fd)
                                         to_keep (Obj.magic pa) with
                                 | Ok x7 ->
                                   let pe =
                                   ...
                                   (match live_range_splitting asm_e aparams
                                    ...
                                    | Ok x8 ->
                                      (match remove_glob_prog (asm_opI asm_e)
                                               asm_e._asm._arch_decl.ad_fcp x8 with
                                       | Ok x9 ->
                                         let pg =
...
let compiler_back_end asm_e call_conv aparams cparams entries pd =
  ...
  | Ok _ ->
    (match Merge_varmaps.check (arch_pd asm_e._asm._arch_decl)
             (asm_opI asm_e)
