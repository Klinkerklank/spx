...
val get_hw : halfword -> (register, empty, empty, rflag, condt) wreg -> word
...
val bit_field_extract_semi :
  ...
  -> word -> word -> (register, empty, empty, rflag, condt) wreg exec
...
val extend_bits_semi :
  coq_Z -> (register, empty, empty, rflag, condt) wreg -> word -> (register,
  empty, empty, rflag, condt) wreg
