...
val rflags_of_aluop : wsize -> Word0.word -> coq_Z -> coq_Z -> sem_tuple
...
val rflags_of_aluop_w : wsize -> Word0.word -> coq_Z -> coq_Z -> ltuple
...
val x86_CMOVcc : wsize -> bool -> Word0.word -> Word0.word -> sem_tuple
...
val x86_VPMOVSX : velem -> wsize -> velem -> wsize -> Word0.word -> Word0.word
...
val x86_VPMOVZX : velem -> wsize -> velem -> wsize -> Word0.word -> Word0.word
...
val x86_VPADD : velem -> wsize -> Word0.word -> Word0.word -> Word0.word

val coq_Ox86_VPADD_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPSUB : velem -> wsize -> Word0.word -> Word0.word -> Word0.word

val coq_Ox86_VPSUB_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPAVG : velem -> wsize -> Word0.word -> Word0.word -> Word0.word

val coq_Ox86_VPAVG_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPMULL : velem -> wsize -> Word0.word -> Word0.word -> Word0.word
...
val x86_VPINSR : velem -> Word0.word -> Word0.word -> Word0.word -> sem_tuple
...
val x86_VPSLL : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPSLL_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPSRL : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPSRL_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPSRA : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple
...
val x86_VPSLLV : wsize -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPSLLV_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPSRLV : wsize -> wsize -> Word0.word -> Word0.word -> sem_tuple
...
val x86_VPUNPCKH : velem -> wsize -> Word0.word -> Word0.word -> Word0.word

val coq_Ox86_VPUNPCKH_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPUNPCKL : velem -> wsize -> Word0.word -> Word0.word -> Word0.word
...
val coq_SaturatedSignedToUnsigned : wsize -> wsize -> Word0.word -> Word0.word

val coq_SaturatedSignedToSigned : wsize -> wsize -> Word0.word -> Word0.word
...
val x86_VSHUFPS : wsize -> Word0.word -> Word0.word -> Word0.word -> sem_tuple
...
val x86_VPALIGNR128 : Word0.word -> Word0.word -> Word0.word -> Word0.word
...
val x86_VINSERTI128 : Word0.word -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VINSERTI128_instr :
  (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t * (string * x86_op prim_constructor)

val x86_VPERM2I128 : Word0.word -> Word0.word -> Word0.word -> sem_tuple
...
val x86_VPCMPEQ : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPCMPEQ_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPCMPGT : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPCMPGT_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPSIGN : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple
...
val x86_VPMINS : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPMINS_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPMINU : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPMINU_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPMAXS : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple

val coq_Ox86_VPMAXS_instr :
  (velem -> wsize -> (register, register_ext, xmm_register, rflag, condt)
  instr_desc_t) * (string * x86_op prim_constructor)

val x86_VPMAXU : velem -> wsize -> Word0.word -> Word0.word -> sem_tuple
